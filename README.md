...
The latest available download version [v0.7.1 Private Beta is here](https://drive.google.com/file/d/1kWJEzem6alpqehCDCoCrudJp_GBc4Q-w/view?usp=drive_link).  
The latest ALP (Approofed für Lan Party) version is [the previous release: v0.6.0, tested with 8 players](https://drive.google.com/file/d/1mQHlZnRwHb49QlxFFJzH5OrF5sCReG67/view?usp=drive_link).  
...
**Movement**
 ...
 - **LCTRL:** crouch/duck (both on foot and in air with or without flying device);
...
**Weapons**
 ...
 - **1,2,3,4,5,6,7,8 / Mouse Wheel**: change weapon (knife, pistol, machine gun, bazooka, pusha, machine pistol, shotgun, grenade launcher);
