...
protected:
    ...
    virtual void initialize() override
    {
        ...
        addSubTest("test_findNextValidPlayerToFollowInPlayerSpectatingView_togglingSpectatorMode_and_removingPlayers",
            static_cast<PFNUNITSUBTEST>(&CameraHandlingTest::test_findNextValidPlayerToFollowInPlayerSpectatingView_togglingSpectatorMode_and_removingPlayers));
        addSubTest("test_findNextValidPlayerToFollowInPlayerSpectatingView_togglingForcedSpectating",
            static_cast<PFNUNITSUBTEST>(&CameraHandlingTest::test_findNextValidPlayerToFollowInPlayerSpectatingView_togglingForcedSpectating));
        addSubTest("test_findNextValidPlayerToFollowInPlayerSpectatingView_togglingSpectatorMode_and_removingPlayers_aux",
            static_cast<PFNUNITSUBTEST>(&CameraHandlingTest::test_findNextValidPlayerToFollowInPlayerSpectatingView_togglingSpectatorMode_and_removingPlayers_aux));
        addSubTest("test_findNextValidPlayerToFollowInPlayerSpectatingView_togglingForcedSpectating_aux",
            static_cast<PFNUNITSUBTEST>(&CameraHandlingTest::test_findNextValidPlayerToFollowInPlayerSpectatingView_togglingForcedSpectating_aux));
        addSubTest("test_findPrevValidPlayerToFollowInPlayerSpectatingView_togglingSpectatorMode_and_removingPlayers",
            static_cast<PFNUNITSUBTEST>(&CameraHandlingTest::test_findPrevValidPlayerToFollowInPlayerSpectatingView_togglingSpectatorMode_and_removingPlayers));
        addSubTest("test_findPrevValidPlayerToFollowInPlayerSpectatingView_togglingForcedSpectating",
            static_cast<PFNUNITSUBTEST>(&CameraHandlingTest::test_findPrevValidPlayerToFollowInPlayerSpectatingView_togglingForcedSpectating));
        addSubTest("test_findPrevValidPlayerToFollowInPlayerSpectatingView_togglingSpectatorMode_and_removingPlayers_aux",
            static_cast<PFNUNITSUBTEST>(&CameraHandlingTest::test_findPrevValidPlayerToFollowInPlayerSpectatingView_togglingSpectatorMode_and_removingPlayers_aux));
        addSubTest("test_findPrevValidPlayerToFollowInPlayerSpectatingView_togglingForcedSpectating_aux",
            static_cast<PFNUNITSUBTEST>(&CameraHandlingTest::test_findPrevValidPlayerToFollowInPlayerSpectatingView_togglingForcedSpectating_aux));
        addSubTest("test_findAnyValidPlayerToFollowInPlayerSpectatingView_togglingSpectatorMode_and_removingPlayers",
            static_cast<PFNUNITSUBTEST>(&CameraHandlingTest::test_findAnyValidPlayerToFollowInPlayerSpectatingView_togglingSpectatorMode_and_removingPlayers));
        addSubTest("test_findAnyValidPlayerToFollowInPlayerSpectatingView_togglingForcedSpectating",
            static_cast<PFNUNITSUBTEST>(&CameraHandlingTest::test_findAnyValidPlayerToFollowInPlayerSpectatingView_togglingForcedSpectating));
    }
    ...
    */
    ...
    bool test_ctor()
    {
        ...
        b &= assertEquals(
            ...
            "spectating view");
        // b &= assertEquals(PureVector(), camera.cameraGetPosToFollowWhenSpectating(), "pos to follow");  // not public function
        b &= assertEquals(pge_network::ServerConnHandle, camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "conn handle");
    ...
    bool test_findNextValidPlayerToFollowInPlayerSpectatingView_togglingSpectatorMode_and_removingPlayers()
    {
        ...
        b &= assertEquals(player1.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 5");

        b &= assertTrue(camera.findNextValidPlayerToFollowInPlayerSpectatingView(m_mapPlayers), "find 6");
        b &= assertEquals(player2.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 6");

        b &= assertTrue(camera.findNextValidPlayerToFollowInPlayerSpectatingView(m_mapPlayers), "find 7");
        b &= assertEquals(player3.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 7");
        ...
        b &= assertEquals(player0.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 8");
        ...
        b &= assertEquals(player1.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 9");
        ...
        b &= assertEquals(player0.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 10");
        ...
        b &= assertEquals(player3.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 12");
        ...
        b &= assertEquals(player2.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 13");

        // try again but should be same
        b &= assertTrue(camera.findNextValidPlayerToFollowInPlayerSpectatingView(m_mapPlayers), "find 14");
        b &= assertEquals(player2.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 14");
        ...
        b &= assertEquals(player3.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 17");
        ...
        b &= assertEquals(player2.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 19");

        // try find again
        b &= assertTrue(camera.findNextValidPlayerToFollowInPlayerSpectatingView(m_mapPlayers), "find 20");
        b &= assertEquals(player2.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 20");
    ...
    bool test_findNextValidPlayerToFollowInPlayerSpectatingView_togglingForcedSpectating()
    {
        ...
        // we are already spectating player 0 at this point
        b &= assertTrue(camera.findNextValidPlayerToFollowInPlayerSpectatingView(m_mapPlayers), "find 2");
        b &= assertEquals(player1.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 2");

        // force current spectated player to spectate then try find again
        player1.setForcedSpectating(true);
        b &= assertTrue(camera.findNextValidPlayerToFollowInPlayerSpectatingView(m_mapPlayers), "find 3");
        b &= assertEquals(player2.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 3");
        ...
        b &= assertEquals(player3.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 4");

        player3.setForcedSpectating(true);
        // beginning of container again
        b &= assertTrue(camera.findNextValidPlayerToFollowInPlayerSpectatingView(m_mapPlayers), "find 5");
        b &= assertEquals(player0.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 5");
        
        // try again
        b &= assertTrue(camera.findNextValidPlayerToFollowInPlayerSpectatingView(m_mapPlayers), "find 6");
        b &= assertEquals(player0.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 6");

        player3.setForcedSpectating(false);
        ...
        b &= assertFalse(camera.findNextValidPlayerToFollowInPlayerSpectatingView(m_mapPlayers), "find 9");
    ...
    bool test_findNextValidPlayerToFollowInPlayerSpectatingView_togglingSpectatorMode_and_removingPlayers_aux()
    {
        ...
        player2.isInSpectatorMode() = false;
        b &= assertTrue(camera.findNextValidPlayerToFollowInPlayerSpectatingView(m_mapPlayers), "find 2");
        b &= assertEquals(player2.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 2");
    ...
    bool test_findNextValidPlayerToFollowInPlayerSpectatingView_togglingForcedSpectating_aux()
    {
        ...
        // player2 is forced to spectate now
        player2.setForcedSpectating(true);
        b &= assertFalse(camera.findNextValidPlayerToFollowInPlayerSpectatingView(m_mapPlayers), "find 3");
        // try again, should be same
        b &= assertFalse(camera.findNextValidPlayerToFollowInPlayerSpectatingView(m_mapPlayers), "find 4");
    ...
    bool test_findPrevValidPlayerToFollowInPlayerSpectatingView_togglingSpectatorMode_and_removingPlayers()
    {
        ...
        b &= assertEquals(player3.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 5");
        ...
        b &= assertEquals(player1.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 7");
        ...
        b &= assertEquals(player3.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 9");
        ...
        b &= assertEquals(player1.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 11");

        b &= assertTrue(camera.findPrevValidPlayerToFollowInPlayerSpectatingView(m_mapPlayers), "find 12");
        b &= assertEquals(player0.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 12");
        ...
        b &= assertEquals(player1.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 13");

        // try again but should be same
        b &= assertTrue(camera.findPrevValidPlayerToFollowInPlayerSpectatingView(m_mapPlayers), "find 14");
        b &= assertEquals(player1.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 14");
        ...
        b &= assertEquals(player0.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 17");
        ...
        b &= assertEquals(player1.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 19");

        // try find again
        b &= assertTrue(camera.findPrevValidPlayerToFollowInPlayerSpectatingView(m_mapPlayers), "find 20");
        b &= assertEquals(player1.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 20");
    ...
    bool test_findPrevValidPlayerToFollowInPlayerSpectatingView_togglingForcedSpectating()
    {
        ...
        // we are already spectating player 0 at this point
        b &= assertTrue(camera.findPrevValidPlayerToFollowInPlayerSpectatingView(m_mapPlayers), "find 2");
        b &= assertEquals(player3.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 2");
        ...
        player2.setForcedSpectating(true);
        b &= assertTrue(camera.findPrevValidPlayerToFollowInPlayerSpectatingView(m_mapPlayers), "find 4");
        b &= assertEquals(player1.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 4");
        ...
        player2.setForcedSpectating(false);

        b &= assertTrue(camera.findPrevValidPlayerToFollowInPlayerSpectatingView(m_mapPlayers), "find 8");
        b &= assertEquals(player2.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 7");

        player2.setForcedSpectating(true);
        player0.setForcedSpectating(true);
        b &= assertFalse(camera.findPrevValidPlayerToFollowInPlayerSpectatingView(m_mapPlayers), "find 9");
    ...
    bool test_findPrevValidPlayerToFollowInPlayerSpectatingView_togglingSpectatorMode_and_removingPlayers_aux()
    {
        ...
        player3.isInSpectatorMode() = false;
        b &= assertTrue(camera.findPrevValidPlayerToFollowInPlayerSpectatingView(m_mapPlayers), "find 3");
        b &= assertEquals(player3.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 3");
    ...
    bool test_findAnyValidPlayerToFollowInPlayerSpectatingView_togglingSpectatorMode_and_removingPlayers()
    {
        ...
        b &= assertEquals(player0.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 4");
        ...
        b &= assertEquals(player2.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 8");
        ...
        b &= assertEquals(player2.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 9");
        ...
        b &= assertEquals(player3.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 10");
    ...
    bool test_findAnyValidPlayerToFollowInPlayerSpectatingView_togglingForcedSpectating() {
        ...
        // all players join the game
        player0.setForcedSpectating(false);
        player1.isInSpectatorMode() = false;
        player2.isInSpectatorMode() = false;
        player3.isInSpectatorMode() = false;
        ...
        b &= assertTrue(camera.findAnyValidPlayerToFollowInPlayerSpectatingView(m_mapPlayers, vecPosToFollow), "find 9");
        b &= assertEquals(player3.getServerSideConnectionHandle(), camera.cameraGetPlayerConnectionHandleToFollowWhenSpectating(), "connhandle 9");
        b &= assertEquals(player3.getObject3D()->getPosVec(), vecPosToFollow, "pos 9");

        // now spectating player3, disconnect it
        b &= assertTrue(m_gm->removePlayer(player3, m_network), "remove player 3 from gamemode");
        b &= assertEquals(1u /* number of deleted elements */, m_mapPlayers.erase(player3.getServerSideConnectionHandle()), "remove player 3 from m_mapPlayers");
        b &= assertEquals(nPlayersExpected - 3, m_mapPlayers.size(), "m_mapPlayers size 3");
        b &= assertEquals(nPlayersExpected - 3, m_gm->getPlayersTable().size(), "gamemode size 3");
        if (!b)
        {
            return false;
        }
        ...
        b &= assertEquals(1u /* number of deleted elements */, m_mapPlayers.erase(player2.getServerSideConnectionHandle()), "remove player 3 from m_mapPlayers");
        b &= assertEquals(nPlayersExpected - 4 /* shall be 0 */, m_mapPlayers.size(), "m_mapPlayers size 3");
        b &= assertEquals(nPlayersExpected - 4 /* shall be 0 */, m_gm->getPlayersTable().size(), "gamemode size 3");

        b &= assertFalse(camera.findAnyValidPlayerToFollowInPlayerSpectatingView(m_mapPlayers, vecPosToFollow), "find 12");
