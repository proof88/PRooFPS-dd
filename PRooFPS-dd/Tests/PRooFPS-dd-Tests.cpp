...
int WINAPI WinMain(const _In_ HINSTANCE /*hInstance*/, const _In_opt_ HINSTANCE /*hPrevInstance*/, const _In_ LPSTR /*lpCmdLine*/, const _In_ int /*nCmdShow*/)
{
    ...
    // regression tests
    tests.push_back(std::unique_ptr<UnitTest>(new RegTestBasicServerClient2Players(60, 60)));
    tests.push_back(std::unique_ptr<UnitTest>(new RegTestBasicServerClient2Players(60, 20)));
    tests.push_back(std::unique_ptr<UnitTest>(new RegTestBasicServerClient2Players(20, 20)));
