...
namespace proofps_dd
{
    ...
    static const std::string GAME_VERSION = "0.5.1 Private Beta";
    static const std::string GAME_VERSION_LATEST_ALP = "0.5.0";
    ...
    static constexpr char GAME_INPUT_KEY_MENU_SERVERADMIN = 'h';
