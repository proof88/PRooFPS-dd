...
Since ALP qualification requires actual testing on a LAN party, sometimes ALP qualification is given retrospectively for a release, but sometimes it is given right at the release when LAN party is testing an unreleased-yet version.
