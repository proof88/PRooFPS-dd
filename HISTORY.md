...
## v0.1.6.1 Private Beta (Dec 27, 2023)

A compressed build for Windows is available for download here TODO add link.
...
A regression test has been also added that is triggering map change in loop with 2 connected clients.
